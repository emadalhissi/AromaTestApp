...
class _HomeScreenState extends State<HomeScreen> {
          ...
          children: [
            SharedPreferencesController().getSliderDownloaded == false
                ...
                : CarouselSlider(
                    ...
                    items: Provider.of<ProductsProvider>(context, listen: false)
                        .homeSliderList_
                        .map((slider) {
                      return Builder(
                        builder: (BuildContext context) {
            ...
            SharedPreferencesController().getCategoriesDownloaded == false
                ? FutureBuilder<List<HomeCategory>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        Provider.of<ProductsProvider>(context, listen: false)
                            .setHomeCategoryList_(list: snapshot.data!);
                        Provider.of<ProductsProvider>(context, listen: false)
                            .setAllProductsList_(
                        ...
                        SharedPreferencesController()
                            .setCategoriesDownloaded(downloaded: true);
                        return Column(
                          children: [
                            Row(
  ...
  Future<void> favoriteProduct(HomeProduct homeProduct) async {
    bool status = await Provider.of<FavoritesProvider>(context, listen: false)
        .updateFavorite(
      context: context,
      product: homeProduct,
    );
